...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(id='payload-slider',
                                                ...
                                                marks={0: '0',2500: '2500', 5000: '5000', 7000: '7500', 10000: '10000'},
                                                value=[2500, 5000]),
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df, values=filtered_df['class'].value_counts().values, names=filtered_df['class'].value_counts().index, title='Total Success Launches by ' + entered_site)
        return fig
